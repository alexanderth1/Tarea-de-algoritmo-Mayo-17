...
funcion ejercicio1(n)
	//	ENT: definir num,j  Como Entero   VARIABLES DE LA FUNCIONN :definir respuesta,i,j Como Entero
	// cresamos un areglo con la vairabld (num) 
	// y la enviamos a la funcion jercicio1(2)
	// proceso: utilisamos una estructura (PARA )
...
funcion ejercicio3
	...
	Definir nume,arreglo,i,valo Como Entero
	escribir "                      ingrese el numero para la secuencia"Sin Saltar
	leer nume
